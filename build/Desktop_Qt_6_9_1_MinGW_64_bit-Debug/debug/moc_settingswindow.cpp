...
template <> constexpr inline auto SettingsWindow::qt_create_metaobjectdata<qt_meta_tag_ZN14SettingsWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "SettingsWindow",
        "on_switchaccountButton_3_clicked",
        "",
        "on_historyButton_2_clicked",
        "on_exitButton_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_switchaccountButton_3_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_historyButton_2_clicked'
...
void SettingsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_switchaccountButton_3_clicked(); break;
        case 1: _t->on_historyButton_2_clicked(); break;
